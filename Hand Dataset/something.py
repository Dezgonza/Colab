...
def generate_csv_files(image_dir):
    ...
    split_data_test_eval_train(r"egohands/_LABELLED_SAMPLES/")
...
def rename_files(image_dir):
    ...
    generate_csv_files(r"egohands/_LABELLED_SAMPLES/")
...
def extract_folder(dataset_path):
    ...
    if not os.path.exists("egohands"):
        ...
        zip_ref.close()
        rename_files(r"egohands/_LABELLED_SAMPLES/")
...
EGOHANDS_DATASET_URL = r"http://vision.soic.indiana.edu/egohands_files/egohands_data.zip"
EGO_HANDS_FILE = r"egohands_data.zip"
